...
var automobiles = [ 
    ...
    new Automobile(2007, "Lotus", "Elise", "Roadster"),
    new Automobile(2008, "Subaru", "Crosstrek", "SUV"),
    new Automobile(2010, "Subaru", "Impreza", "Roadster"),
    new Automobile(2005, "Aston Martin", "Vanquish", "Roadster"),
    new Automobile(2008, "Subaru", "Outback", "Wagon")
    ];

/*This function sorts arrays using an arbitrary comparator. You pass it a comparator and an array of 
objects appropriate for that comparator and it will return a new array which is sorted with 
the largest object in index 0 and the smallest in the last index*/
function sortArr( comparator, array ){
    /*your code here*/
    return array.sort((auto1, auto2) => comparator(auto1, auto2));
}

/*A comparator takes two arguments and uses some algorithm to compare them. If the first argument is 
larger or greater than the 2nd it returns true, otherwise it returns false. Here is an example that 
works on integers*/
...
function typeComparator( auto1, auto2){
    /* your code here*/
    var weight = ["wagon", "suv", "pickup", "roadster"];
    if(weight.indexOf(auto1.type.toLowerCase()) === weight.indexOf(auto2.type.toLowerCase())) {
    	return yearComparator(auto1, auto2);
    }
    return weight.indexOf(auto1.type.toLowerCase()) < weight.indexOf(auto2.type.toLowerCase());
}
...
Each line representing a car should be produced via a logMe function. This function should be added to 
the Automobile class and accept a single boolean argument. If the argument is 'true' then it prints "year make model type" 
...
automobiles.forEach(auto => auto.logMe(false));
...
automobiles.forEach(auto => auto.logMe(true));
console.log("*****");